<div>
    <x-notifications/>
    <form class="p-8 bg-blue-200 flex flex-col mx-auto w-1/2 gap-4">
    ...
    <div class="container mx-auto grid justify-items-start">        
        <div class="ml-6">
            ...
            <table class="border-collapse m-6">
                <thead>
                    <tr>
                    ...
                    @foreach ($addresses as $address)
                        <tr class="odd:bg-white even:bg-slate-50">
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <button class="text-red-500 m-1" wire:click="remove({{ $address['id'] }})" type="button">Excluir</button>
                            </td>                    
                        </tr>      
                    @endforeach
